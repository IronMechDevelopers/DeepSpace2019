...
public class FollowPath extends Command {
  ...
  protected void execute() {
    if (m_left_follower.isFinished() || m_right_follower.isFinished()) {
      ...
      System.out.println("left_speed: " + left_speed);
      System.out.println("right_speed: " + right_speed);
      System.out.println("Our reading left: " + m_left_encoder.getRate());
      System.out.println("Our reading right: " + m_right_encoder.getRate());
